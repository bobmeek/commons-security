package commons.security.digests;

/**
 * 著名的非对称算法RSA发明人之一—麻省理工学院教授罗纳德·李维斯特（Ronald L. Rivest）开发了MD2算法。
 * MD2算法首先对信息进行数据补位，使信息的字节长度是16的倍数。
 * 再以一个16位的检验和作为补充信息追加到原信息的末尾。
 * 最后根据这个新产生的信息计算出一个128位的散列值
 * 
 * implementation of MD2
 * as outlined in RFC1319 by B.Kaliski from RSA Laboratories April 1992
 */
public class MD2Digest  implements Digest
{
